...
$spot_msg = "SELECT * FROM ContactUs WHERE id = '$messageId' LIMIT 1";
...
if (isset($_POST["update_message"])) {
    ...
    $update_message = "UPDATE ContactUs SET name = '$fullname', email = '$email', message = '$text_message' WHERE id = '$messageId' LIMIT 1";
...
<head>
    ...
    <title>Update Contact Us Message - Gadget World</title>
    <link rel="stylesheet" href="styles.css">
</head>
<body>
    <header>
        <img src="images/GadgetWorldLogo.png" alt="Gadget World Logo" class="logo">
    ...
    <main>
        <div class="content">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . '?id=' . $messageId; ?>" method="POST" class="form">
